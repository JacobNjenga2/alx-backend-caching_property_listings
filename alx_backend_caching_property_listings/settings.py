...
SECRET_KEY = 'django-insecure-8dmt2lz7ai@eu=&0oij!c_9avfl8@x*sblzz%0#ydz@c0aw9jh'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://localhost:6379/1',  # Use 'redis://redis:6379/1' when running in Docker
        'OPTIONS': {
